      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between'>
        <div className='flex items-center gap-8'>
          <a href='#' className='flex items-center gap-2.5 group'>
            <div className='w-10 h-10 rounded-xl bg-linear-to-tr from-indigo-500 via-purple-500 to-pink-500 p-[1.5px] shadow-lg shadow-indigo-500/20 group-hover:scale-105 transition-transform duration-300'>
            ...
            <div className='flex flex-col'>
              <span className='text-xl font-bold tracking-tight bg-clip-text text-transparent bg-linear-to-r from-white via-slate-100 to-slate-400'>
                Jobloom
              </span>
        ...
        <div className='flex items-center gap-3'>
          ...
          <button className='relative group overflow-hidden text-sm font-semibold px-5 py-2.5 rounded-xl bg-linear-to-r from-indigo-500 via-purple-500 to-pink-500 hover:opacity-95 shadow-md shadow-indigo-500/25 transition-all active:scale-95 cursor-pointer'>
