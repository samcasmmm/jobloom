...
export const JobSearchBar: React.FC<JobSearchBarProps> = ({
  onSearch,
  trendingRoles = defaultTrendingRoles,
}) => {
  ...
  return (
    <div className="w-full max-w-4xl mt-10">
      ...
      >
        {/* Role Query Input */}
        <div className="flex-1 flex items-center gap-3 px-3.5 py-2.5 sm:py-2 rounded-xl bg-white/[0.04] border border-white/5 focus-within:bg-white/[0.07] transition-all">
        ...
        {/* Location Selector */}
        <div className="sm:w-60 flex items-center gap-3 px-3.5 py-2.5 sm:py-2 rounded-xl bg-white/[0.04] border border-white/5 focus-within:bg-white/[0.07] transition-all">
      ...
      <div className="mt-4 flex flex-wrap items-center justify-center gap-2 text-xs sm:text-sm text-zinc-400">
        ...
        {trendingRoles.map((role) => (
          <button
            ...
            className="px-3 py-1 rounded-lg bg-white/[0.05] hover:bg-white/[0.1] border border-white/10 text-zinc-300 hover:text-white transition-all cursor-pointer"
          >
            {role}
          </button>
        ))}
