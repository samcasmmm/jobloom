...
export const FeatureCards: React.FC = () => {
  return (
    <div className='grid grid-cols-1 md:grid-cols-3 gap-5 w-full max-w-5xl mt-14 sm:mt-16 text-left'>
      {/* Card 1 */}
      <div className='p-5 rounded-2xl bg-white/3 backdrop-blur-lg border border-white/10 hover:border-indigo-500/40 transition-all group'>
      ...
      {/* Card 2 */}
      <div className='p-5 rounded-2xl bg-white/3 backdrop-blur-lg border border-white/10 hover:border-pink-500/40 transition-all group'>
        <div className='flex items-center justify-between mb-3'>
      ...
      {/* Card 3 */}
      <div className='p-5 rounded-2xl bg-white/3 backdrop-blur-lg border border-white/10 hover:border-cyan-500/40 transition-all group'>
        <div className='flex items-center justify-between mb-3'>
