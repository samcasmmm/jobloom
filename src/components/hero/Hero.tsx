...
export const Hero: React.FC = () => {
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-[#0a0a0f] text-white flex flex-col justify-between selection:bg-indigo-500 selection:text-white">
      ...
      <div className="absolute inset-0 z-[1] bg-gradient-to-b from-black/60 via-black/20 to-[#0a0a0f] pointer-events-none" />
      <div className="absolute inset-0 z-[1] bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-indigo-500/15 via-transparent to-transparent pointer-events-none" />
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 sm:pt-20 pb-16 flex flex-col items-center text-center">
        ...
        <h1 className="text-4xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight max-w-5xl leading-[1.15]">
          ...
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-indigo-400 via-pink-400 to-cyan-300">
            Next-Era Careers
          </span>
        </h1>
        ...
        <p className="mt-6 text-base sm:text-xl text-zinc-300 max-w-3xl font-normal leading-relaxed">
          Jobloom cuts through the noise with deep skill-graph matching, verified salary intelligence, and direct access to engineering teams at the world&apos;s best tech companies.
        </p>
